...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray jsonArray1 = rootObject1.getJSONArray("agent_data1");
        ...
        listView = (ListView) findViewById(R.id.list_company_data);
        adapter = new CompanyAdapter(MainActivity.this, R.id.list_rows, arrayList, names);
